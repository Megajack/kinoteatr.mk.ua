...
/**
 * @file
 * Contains theme override functions and process & preprocess functions for kinoteatr_lite
 */

// Auto-rebuild the theme registry during theme development.
if (theme_get_setting('kinoteatr_lite_clear_registry')) {
  // Rebuild .info data.
 ...
 */
function kinoteatr_lite_html_head_alter(&$head_elements) {
 ...
 */
function kinoteatr_lite_preprocess_search_block_form(&$vars) {
 ...
 */
function kinoteatr_lite_preprocess(&$vars, $hook) {
  $vars['kinoteatr_lite_path'] = base_path() . path_to_theme();
}

/**
 * Implements template_preprocess_html().
 */
function kinoteatr_lite_preprocess_html(&$vars) {
  
  $vars['doctype'] = _kinoteatr_lite_doctype();
  $vars['rdf'] = _kinoteatr_lite_rdf($vars);
  ...
  if (!$vars['is_front']) {
    ...
    if (isset($page_name)) {
      $vars['classes_array'][] = kinoteatr_lite_id_safe('page-' . $page_name);
    }

    $vars['classes_array'][] = kinoteatr_lite_id_safe('section-' . $section);
 ...
 */
function kinoteatr_lite_preprocess_page(&$vars) {
  ...
  if(!theme_get_setting('kinoteatr_lite_feed_icons')) {
    $vars['feed_icons'] = '';
  }
}
 ...
 */
function kinoteatr_lite_preprocess_maintenance_page(&$vars) {
  ...
  drupal_add_css(drupal_get_path('theme', 'kinoteatr_lite') . '/css/maintenance-page.css');
}
 ...
 */
function kinoteatr_lite_preprocess_node(&$vars) {
  // Striping class
 ...
 */
function kinoteatr_lite_preprocess_block(&$vars, $hook) {
 ...
 */
function kinoteatr_lite_menu_tree($vars) {
 ...
 */
function kinoteatr_lite_field__taxonomy_term_reference($vars) {
  $output = '';
 ...
 */
function kinoteatr_lite_breadcrumb($vars) {
 ...
 * @return bool
 */
function kinoteatr_lite_tabs_float() {
  $float = (bool) theme_get_setting('kinoteatr_lite_tabs_float');
  $float_node = (bool) theme_get_setting('kinoteatr_lite_tabs_node');
...
function kinoteatr_lite_id_safe($string) {
  // Strip accents
 ...
 */
function _kinoteatr_lite_doctype() {
 ...
 * @param array $vars
 */
function _kinoteatr_lite_rdf($vars) {
  $rdf = new stdClass();
 ...
 * @ingroup themeable
 */
function kinoteatr_lite_menu_link(array $vars) {
  ...
  $element['#attributes']['class'][] = kinoteatr_lite_id_safe($element['#title']);
 ...
 */
function kinoteatr_lite_preprocess_menu_local_task(&$vars) {
 ...
 */
function kinoteatr_lite_menu_local_tasks(&$vars) {
  $output = '';
